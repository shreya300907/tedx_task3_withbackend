...
export default function Checkout() {
    ...
    return (
        <motion.div
            ...
            className="px-8 py-8 w-[70vw] mx-auto item-center"
        >
            ...
            <div className="flex flex-row bg-background border">
                <div className="px-8 py-8 flex flex-col justify-between">
                    <div className="flex flex-col ">
                        <div className="pb-8 text-secondary-foreground font-mono text-[10px] tracking-[1px]">
                            PROGRESS
                        </div>
                        <div >
                    ...
                    <div className="mt-4 whitespace-nowrap px-4 py-4 bg-[#F5F5F4] font-mono text-xs text-[#79716B] border">
            ...
            <div className="px-12 py-6 bg-white border flex flex-row  justify-between items-center">
                <div>
                    {step === 2 || step === 3 ? (
                        <button className="flex flex-row items-center cursor-pointer" onClick={prevStep}>
                            <img src="/back.svg" alt="back" className="h-4 mr-2" />
                            <span className="text-[14px] font-medium tracking-[0.7px] text-primary-foreground">BACK</span>
                        </button>
                    ) : (
                        <></>
                    )}
                ...
                <button type="submit" form={step === 1 ? "coordinates-form" : step === 2 ? "routes-form" : "manifest-form"} className="flex flex-row cursor-pointer items-center hover:bg-foreground py-3 px-6 bg-[#A6A09B]">
                    <span className="text-[14px] font-medium tracking-[0.7px] text-white pr-3">{step === 1 || step === 2 ? "CONTINUE" : "PROCEED TO PAY"}</span>
